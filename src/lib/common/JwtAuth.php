...
class JwtAuth
{
    ...
    /**
     * Token expires length
     *
     * @var WP_Error
     */
    private $expiresLength = null;
    ...
    public function __construct($plugin_name, $version)
    {
        ...
        $this->namespace = 'jwt-auth/v'.intval($this->version);
        $this->expiresLength = (MONTH_IN_SECONDS * 6);
    }
    ...
    public function add_cors_support()
    {
        ...
        if ($enable_cors) {
            $headers = apply_filters('jwt_auth_cors_allow_headers', 'Access-Control-Allow-Headers, Content-Type, Authorization, X-WP-Nonce');
    ...
    public function generate_token($request)
    {
        ...
        $expire = apply_filters('jwt_auth_expire', $issuedAt + $this->expiresLength, $issuedAt);
